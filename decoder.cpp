...
uint8_t getimm11_0(uint32_t inst) {
    uint8_t imm11_0;
...
void checkOpcode(uint32_t inst) {;
...
string check_type(string opcode) {
    ...
    "divw", "divuw", "remw", "remuw", "and", "or", "xor", "sll", "srl", "sra", "sllw", "srkw", "sraw", "slt", "sltu" };
...
void controlSignalRtype() {
    ...
    mem_we = 0; mem_re = 0;
    sel_1 = 0; sel_2 = 0; sel_3 = 0; sel_4 = 0;
    sel_5 = 0; sel_6 = 1; sel_7 = 0; sel_8 = 0;
...
void controlSignalItype(string opcode) {
    ...
    const static unordered_map<string, int> stringToNum{
        //Itype list
        {"lb",1}, {"lw",1}, {"lh",1}, {"lbu",1}, {"lhu",1}, {"lwu",1}, {"ld",1},
    ...
    case 1: reg_we = 1; reg_re = 1; alu_op = 1;
        mem_we = 0; mem_re = 1;
        sel_1 = 1; sel_2 = 1; sel_3 = 1; sel_4 = 0;
        sel_5 = 0; sel_6 = 1; sel_7 = 1; sel_8 = 0;
        branch = 0; lui = 0; auipc = 0;
        break;
        //addi, addiw, andi, ori, xori, slti, sltiu,
    case 2: reg_we = 1; reg_re = 1; alu_op = 1;
        mem_we = 0; mem_re = 0;
        sel_1 = 1; sel_2 = 1; sel_3 = 0; sel_4 = 0;
        sel_5 = 0; sel_6 = 1; sel_7 = 0; sel_8 = 0;
        branch = 0; lui = 0; auipc = 0;
        break;
    ...
    case 3: reg_we = 1; reg_re = 1; alu_op = 1;
        mem_we = 0; mem_re = 0;
        sel_1 = 0; sel_2 = 1; sel_3 = 0; sel_4 = 0;
        sel_5 = 0; sel_6 = 1; sel_7 = 0; sel_8 = 0;
        branch = 0; lui = 0; auipc = 0;
        break;
        //jalr
    case 4: reg_we = 1; reg_re = 1; alu_op = 1;
        mem_we = 0; mem_re = 0;
        sel_1 = 1; sel_2 = 1; sel_3 = 0; sel_4 = 1;
        sel_5 = 1; sel_6 = 1; sel_7 = 0; sel_8 = 0;
        branch = 0; lui = 0; auipc = 0;
        break;
    }
}
...
void controlSignalBtype() {
    ...
    mem_we = 0; mem_re = 0;
    sel_1 = 0; sel_2 = 0; sel_3 = 0; sel_4 = 0;
    sel_5 = 0; sel_6 = 1; sel_7 = 0; sel_8 = 1;
...
void controlSignalUtype() {
    ...
    if (opcodeN == "lui") {
        ...
        mem_we = 0; mem_re = 0;
        sel_1 = 1; sel_2 = 1; sel_3 = 0; sel_4 = 0;
        sel_5 = 0; sel_6 = 0; sel_7 = 0; sel_8 = 0;
...
void controlSignalJtype() {
    ...
    mem_we = 0; mem_re = 0;
    sel_1 = 1; sel_2 = 1; sel_3 = 0; sel_4 = 1;
    sel_5 = 1; sel_6 = 0; sel_7 = 0; sel_8 = 0;
    branch = 0; lui = 0; auipc = 0;
}
...
void printList(uint32_t inst) {
    ...
    if (opcodeN == "jalr" || opcodeN == "lui" || opcodeN == "auipc") {
        cout << "\nInstruction: " << opcodeN << " x" << bitset<8>(getrd(inst)).to_ulong();
    }
    else {
    ...
    cout << "\nreg_we:" << reg_we << " reg_re:" << reg_re << " alu_op: " << alu_op << "\nmem_we:" << mem_we << " mem_re:" << mem_re <<
        "\nsel_1:" << sel_1 << " sel_2:" << sel_2 << " sel_3:" << sel_3 << " sel_4:" << sel_4 << "\nsel_5:" << sel_5 << " sel_6:" <<
        sel_6 << " sel_7:" << sel_7 << " sel_8:" << sel_8 << "\nbranch:" << branch << " lui:" << lui << " auipc:" << auipc << "\n\n";
}
...
int main() {
    ...
    uint32_t inst[] = { 0b00000000001100010000001110110011,
        ...
        0b00000000001100010000001110010011,
        0b00000000111111011001010100110011,
        0b00000000101110010010100110110011,
        0b00000001100101110100011000110011,
        0b00000001111011010110011100110011,
        0b00000001010010010111101110110011,
        0b00000000001000011010010010000011,
        0b00000011101101111010000010100011,
        0b00000000001100001000000001100011,
        0b00000000001100101000011001100111,
        0b00000000001100101000101000110111,
        0b00000000001100101000010100010111
    };
